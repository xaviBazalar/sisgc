    ...
    for ($i = 2,$h=1; $i <= $data->sheets[$x]['numRows']; $i++,$h++) {// defino $i=2 para q no tome la primera fila q es la cabecera
                ...
                for ($j = 1; $j <= $data->sheets[$x]['numCols']; $j++) {
					...
					if($j==$data->sheets[$x]['numCols']){
						...
						$db->Execute("Update telefonos set idestado=0 where idcliente='".trim($data->sheets[$x]['cells'][$i][2])."'");
						...
						values(1,1,'".$data->sheets[$x]['cells'][$i][2]."','".addslashes($data->sheets[$x]['cells'][$i][7])."','".$data->sheets[$x]['cells'][$i][1]."-".$data->sheets[$x]['cells'][$i][3]."-".$data->sheets[$x]['cells'][$i][4]."')";
						...
						if($data->sheets[$x]['cells'][$i][15]!="" and $data->sheets[$x]['cells'][$i][15]!="NULL"){
							...
							if(substr($data->sheets[$x]['cells'][$i][15],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][15]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][15]."'";
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][15]."','')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][16]!="" and $data->sheets[$x]['cells'][$i][16]!="NULL"){
							
							if(substr($data->sheets[$x]['cells'][$i][16],0,1)==9){$oriT=5;}else{$oriT=2;}
							...
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][16]."'";
						...
						if($data->sheets[$x]['cells'][$i][17]!="" and $data->sheets[$x]['cells'][$i][17]!="NULL"){
							...
							if(substr($data->sheets[$x]['cells'][$i][17],0,1)==9){$oriT=5;}else{$oriT=2;}
							...
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][17]."'";
						...
						if($data->sheets[$x]['cells'][$i][18]!="" and $data->sheets[$x]['cells'][$i][18]!="NULL"){
							...
							if(substr($data->sheets[$x]['cells'][$i][18],0,1)==9){$oriT=6;}else{$oriT=3;}
							...
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT,observacion='".$data->sheets[$x]['cells'][$i][19]."' where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][18]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][18]."','".$data->sheets[$x]['cells'][$i][19]."')";
							++$l;
						}
						...
						if($data->sheets[$x]['cells'][$i][33]!="" and $data->sheets[$x]['cells'][$i][33]!="NULL"){	
							...
							if(substr($data->sheets[$x]['cells'][$i][33],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][33]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][33]."'";
				
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][33]."','')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][34]!="" and $data->sheets[$x]['cells'][$i][34]!="NULL"){
						
							if(substr($data->sheets[$x]['cells'][$i][34],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][34]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][34]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][34]."','')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][35]!="" and $data->sheets[$x]['cells'][$i][35]!="NULL"){
						
							if(substr($data->sheets[$x]['cells'][$i][35],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][35]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][35]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][35]."','')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][36]!="" and $data->sheets[$x]['cells'][$i][36]!="NULL"){
						
							if(substr($data->sheets[$x]['cells'][$i][36],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][36]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][36]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][36]."','')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][37]!="" and $data->sheets[$x]['cells'][$i][37]!="NULL"){
						
							if(substr($data->sheets[$x]['cells'][$i][37],0,1)==9){$oriT=5;}else{$oriT=2;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][37]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][37]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][37]."','')";
							++$l;
						}
						...
						if($data->sheets[$x]['cells'][$i][30]!="" and $data->sheets[$x]['cells'][$i][30]!="NULL"){
							...
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][30]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT,observacion='".$data->sheets[$x]['cells'][$i][29]."' where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][30]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][30]."','".$data->sheets[$x]['cells'][$i][29]."')";
							++$l;
						}
						
						if($data->sheets[$x]['cells'][$i][32]!="" and $data->sheets[$x]['cells'][$i][32]!="NULL"){
						
							if(substr($data->sheets[$x]['cells'][$i][32],0,1)==9){$oriT=7;}else{$oriT=4;}
							$flag_cta[2][$l]="select idcliente from telefonos where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][32]."'";
							$update_cta[2][$l]="update telefonos set idestado=1,idorigentelefono=$oriT,observacion='".$data->sheets[$x]['cells'][$i][31]."' where idcliente='".$data->sheets[$x]['cells'][$i][2]."' and telefono='".$data->sheets[$x]['cells'][$i][32]."'";
							
							$telefonos[$l]="INSERT INTO telefonos (idfuente,idorigentelefono,idcliente,telefono,observacion)
							values (1,$oriT,'".$data->sheets[$x]['cells'][$i][2]."','".$data->sheets[$x]['cells'][$i][32]."','".$data->sheets[$x]['cells'][$i][31]."')";
							++$l;
						}
						}
