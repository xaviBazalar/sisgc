		...
		?>
			<tr>
				...
				<td width="100%">
					<span id="span_botones"><input type="hidden" value="excel" name="acc">&nbsp;&nbsp;&nbsp;<a href="#" ><input onclick ="rep_bco_c_trama_tv(0);" class="btn" type="button" value="Consultar x Dia" name="consul_bco_c"></a></span>
					<span id="span_botones"><input type="hidden" value="excel" name="acc">&nbsp;&nbsp;&nbsp;<a href="#" ><input onclick ="rep_bco_c_trama_tv(1);" class="btn" type="button" value="Consultar x Mes" name="consul_bco_c"></a></span>
