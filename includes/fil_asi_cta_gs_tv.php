		...
		?>
			<tr>
				<td>
					...
					&nbsp;&nbsp;&nbsp;<b>Resultado:</b>
					<select id="u_rs" name="rs" onchange="res_c(5);"> <!--usuarios_cart();-->
						<option value="">Seleccione..</option>
						<?php
							$sql="select
									r.idresultado,r.resultado
									from resultados r
									join resultado_carteras rc on r.idresultado=rc.idresultado
									where rc.idcartera=52 and r.idestado=1
							...
							while(!$query->EOF){
								...
								echo "<option value='".$query->fields['idresultado']."'>".utf8_encode($query->fields['resultado'])."</option>";
								$query->MoveNext();
							}
						?>
					</select>
