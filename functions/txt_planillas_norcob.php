<?
	...
	//include "/scripts/conexion.php";
	$ano=$_GET['ano'];
	$cm="Select * from planillas_norcob where afp_ano=$ano ";
	if($_GET['mes']!=""){
		$cm.=" and afp_mes=".$_GET['mes'];
	}
	
	$fp=fopen("planilla_norcob.txt",'w');
	...
	fclose($fp);
	echo "Planilla:<a href='guardar_como.php?name=planilla_norcob.txt' target='blank'>Click para descargar</a><br/>";	
