...
$objPHPExcel = new PHPExcel();
	 ...
	 // Add some data
		...
		switch($_GET['riesgo']){
			case 1:
				$riesgo_nom="Riesgo_Alto";
				$fil_ris=" and cp.observacion2='1' ";
				$fil_ris_x=" and cp2.observacion2='1' ";
				$tipo_ciber=2;
				break;
			case 2:
				$riesgo_nom="Riesgo_Medio";
				$fil_ris=" and cp.observacion2='2' ";
				$fil_ris_x=" and cp2.observacion2='2' ";
				$tipo_ciber=3;
				
				break;
			case 3:
				$riesgo_nom="Riesgo_Bajo";
				$fil_ris=" and cp.observacion2='3' ";
				$fil_ris_x=" and cp2.observacion2='3' ";
				$tipo_ciber=4;
				break;
		}
		//$db->debug=true;
...
header('Content-Disposition: attachment;filename="reporte_riesgos_cc.xls"');
