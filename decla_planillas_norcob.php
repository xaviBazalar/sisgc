...
<script>
	function abrirventana()
	{
		...
		window.open("functions/txt_planillas_norcob.php?ano="+ano+"&mes="+mes,"mywindow","menubar=1,resizable=1,width=800,height=600");
	}
</script>
<center>
...
<?
	require "includes/dg/ex1.php";
	require "insert_planilla_norcob.php";
?>